...
# Hardcoded URL for Tenable.io
TENANT_URL = "https://fedcloud.tenable.com"
...
# Initialize TenableIO client with the hardcoded URL
tio = TenableIO(ACCESS_KEY, SECRET_KEY, url=TENANT_URL)
